...
namespace Enerweb.FullStackTest.API.Migrations
{
    ...
    [Migration("20210817082819_FixForeignKeyCascadeDelete")]
    partial class FixForeignKeyCascadeDelete
    {
            ...
            modelBuilder.Entity("Enerweb.FullStackTest.DomainEntities.MeterDataFileDataPeriod", b =>
                {
                    ...
                    b.HasIndex("MeterDataFileServicePointId");
            ...
            modelBuilder.Entity("Enerweb.FullStackTest.DomainEntities.MeterDataFileDataPeriod", b =>
                {
                    ...
                    b.HasOne("Enerweb.FullStackTest.DomainEntities.MeterDataFileServicePoint", "MeterDataFileServicePoint")
                        .WithMany()
                        .HasForeignKey("MeterDataFileServicePointId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MeterDataFileOperatingDate");

                    b.Navigation("MeterDataFileServicePoint");
                });
